...
// Fluids Data 
const fluids = [
  { name: "Maintenance Fluid", rate: 4 }, // Assuming 4 ml/kg/hr as the standard maintenance rate
  // Add more fluid types and their corresponding rates as needed
];
...
// Guidelines Data
const guidelines = [const guidelinesData = [
